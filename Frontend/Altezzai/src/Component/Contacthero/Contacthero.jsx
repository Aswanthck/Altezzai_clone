    ...
    <div className="login">
      ...
      <div className="contact">
        <div className="contact-left">
          ...
          <div class="btn2">
            <a
              class="button-cls hoverbtn"
              href="mailto:enquiry@altezzai.com"
              target="_blank"
            >
              <img src={mail} alt="message icon" draggable="false" />
          ...
          <div class="contact-form">
            ...
            <form action="" class="form-box">
              ...
              <textarea
                ...
                required=""
              ></textarea>
              <button class="send-btn active:to-blue-900" type="submit">
                Send Message
              </button>
            </form>
          </div>
